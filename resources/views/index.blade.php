              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                  <li class="nav-item active">
                    ...
                    <a class="nav-link text-white" href="index.html"><img src="img/logo.png" class="img-fluid logo" alt="Responsive image"></a>
        ...
        <div class="row margin-botao">
          <div class="col">
            <div class="text-center">
              <a href="cadastro_turista.html" class="estilo-green btn btn-primary btn-lg active botao" role="button" aria-pressed="true">Turista</a>
              <a href="cadastro_guia.html" class="estilo-green btn btn-primary btn-lg active botao" role="button" aria-pressed="true">Guia</a>
            </div>
          </div>
        </div>
    </div>
